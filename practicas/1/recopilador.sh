...
OUTPUT+="\n<========== INFROMACION DE LA ORGANIZACION ==========>\n"
OUTPUT+="Organización Propietaria: $OWNER\n"
OUTPUT+="País: $COUNTRY\n"
OUTPUT+="Estado: $STATE\n"
OUTPUT+="Ciudad: $CITY\n"
...
OUTPUT+="Correos del Personal: $EMAIL\n"
OUTPUT+="Teléfonos del Personal: $PHONE\n"
OUTPUT+="\n<========== CONECTIVIDAD ==========>\n"
